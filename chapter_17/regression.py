...
# We'll calculate it by checking how many values have a difference to their ground truth equivalent less than
# given precision. We'll calculate this precision as a fraction of standard deviation of all the ground truth values
...
for epoch in range(10001):
    ...
    # To calculate it we're taking absolute difference between predictions and ground truth values and compare
    # if differences are lower than given precision value
